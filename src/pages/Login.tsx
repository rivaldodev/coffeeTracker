    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-8">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#3E2723]">Bem-vindo de volta</h1>
          <p className="text-gray-500 mt-1">Acompanhe seu consumo de café</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          Não tem uma conta?{' '}
          <Link to="/register" className="text-[#D2691E] hover:underline font-medium">
            Cadastre-se
          </Link>
        </div>
      </motion.div>
